...
async function run() {
    ...
    const branchRows = [
        ['Cabang Praya', 'Jl. Soekarno - Hatta No. 1, Praya, Lombok Tengah', '-8.7063000', '116.2704000'],
        ['Cabang Kopang', 'Jl. Raya Kopang, Kopang, Lombok Tengah', '-8.6416000', '116.3262000'],
        ['Cabang Jonggat', 'Jl. Raya Ubung - Puyung, Jonggat, Lombok Tengah', '-8.6720000', '116.2165000'],
        ['Cabang Pringgarata', 'Jl. Raya Pringgarata, Pringgarata, Lombok Tengah', '-8.6015000', '116.2230000'],
        ['Cabang Pujut', 'Jl. Pariwisata Sengkol - Kuta Mandalika, Pujut, Lombok Tengah', '-8.8475000', '116.2818000'],
        ['Cabang Batukliang', 'Jl. Raya Mantang, Batukliang, Lombok Tengah', '-8.6180000', '116.2870000'],
        ['Cabang Praya Barat', 'Jl. Raya Penujak, Praya Barat, Lombok Tengah', '-8.7512000', '116.2084000'],
        ['Cabang Janapria', 'Jl. Raya Janapria, Janapria, Lombok Tengah', '-8.6850000', '116.3750000'],
    ];
  ...
  `);
    ...
    `, [
        ...
        trackingInserts.push({ ...res.rows[0], status, branchId: soi.destination_branch_id, itemCode: soi.item_code, qty: soi.quantity, installedAt, receivedAt });
    }

    // ─── INSTALLATION ALLOCATIONS & EVIDENCE ──────────────────
    console.log('Seeding installation_allocations and evidence...');

    // Lombok Tengah area coordinates for realistic GIS data
    const gpsPoints = [
        { lat: -8.7063, lon: 116.2704, name: 'Muje, Bundue (Cabang Praya)' },
        { lat: -8.7012, lon: 116.2650, name: 'IPDN (Cabang Praya)' },
        { lat: -8.6416, lon: 116.3262, name: 'Pengendong (Cabang Kopang)' },
        { lat: -8.6720, lon: 116.2165, name: 'Wakul, Bundue (Cabang Jonggat)' },
        { lat: -8.8475, lon: 116.2818, name: 'Darul Falah, Kemualah (Cabang Pujut)' },
        { lat: -8.6180, lon: 116.2870, name: 'Mantang (Cabang Batukliang)' },
        { lat: -8.7512, lon: 116.2084, name: 'Penujak (Cabang Praya Barat)' },
        { lat: -8.6850, lon: 116.3750, name: 'Janapria (Cabang Janapria)' },
    ];
    ...
    for (const track of trackingInserts) {
      ...
      `, [track.id, track.qty, gps.lat.toFixed(7), gps.lon.toFixed(7),
        ...
        `, [
                    ...
                    track.installedAt || new Date().toISOString(),
