...
export const LOMBOK_TENGAH_DISTRICTS: DistrictCenter[] = [
    {
        id: "praya",
 ...
 */
export function resolveDistrictFromCoordinates(lat: number, lon: number): { district: DistrictCenter; distanceKm: number } {
 ...
 */
export function findTargetDistrictForBranch(branchName: string): DistrictCenter | null {
...
export interface DistrictAuditResult {
 ...
 */
export function auditCrossDistrictEvidence(
    branchName: string,
    lat: number,
    lon: number
): DistrictAuditResult {
