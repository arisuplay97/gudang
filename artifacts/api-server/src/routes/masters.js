...
import { CreateCategoryBody, UpdateCategoryBody, UpdateCategoryParams, DeleteCategoryParams, CreateUnitBody, UpdateUnitBody, UpdateUnitParams, DeleteUnitParams, CreateSupplierBody, UpdateSupplierBody, UpdateSupplierParams, DeleteSupplierParams, CreateWarehouseBody, UpdateWarehouseBody, UpdateWarehouseParams, DeleteWarehouseParams, ListLocationsQueryParams, CreateLocationBody, UpdateLocationBody, UpdateLocationParams, DeleteLocationParams, CreateDepartmentBody, UpdateDepartmentBody, UpdateDepartmentParams, DeleteDepartmentParams, } from "@workspace/api-zod";
...
// WAREHOUSES
router.get("/warehouses", requireAuth, async (_req, res) => {
...
router.patch("/warehouses/:id", requireAuth, async (req, res) => {
